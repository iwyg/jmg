...
namespace Thapp\Jmg\Framework\Laravel\Http;

use Illuminate\Http\Request;
use Illuminate\Routing\Router;
use Illuminate\Routing\Controller as BaseController;
use Thapp\Jmg\Http\ImageControllerTrait;
 ...
 * @class Controller
 *
 * @package Thapp\Jmg\Framework\Laravel
 * @version $Id$
...
class Controller extends BaseController
{
     ...
     * @param mixed $filters
     *
     * @return Thapp\Jmg\Http\ImageResponse
     */
