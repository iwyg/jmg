...
class FileystemCacheTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceof('Thapp\Jmg\Cache\FilesystemCache', new FilesystemCache);
    }
    ...
    public function itIsAbleToRetreiveFromKey()
    {
        ...
        $this->assertInstanceof('\Thapp\Jmg\Resource\ResourceInterface', $this->cache->get($key));
    ...
    public function itShouldSetResourceAttributes()
    {
        ...
        $this->assertInstanceof('\Thapp\Jmg\Resource\CachedResource', $res);
