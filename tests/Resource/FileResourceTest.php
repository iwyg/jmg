...
/*
 * This File is part of the Thapp\Jmg\Tests\Resource package
 *
...
use Thapp\Jmg\Resource\FileResource;

/**
 * @class FileResourceTest
 *
 * @package Thapp\Jmg\Tests\Resource
 * @version $Id$
...
class FileResourceTest extends ResourceTest
{
    ...
    public function itShouldBeInstantiable()
    {
        ...
        $this->assertInstanceof('Thapp\Jmg\Resource\ResourceInterface', $resource);
    }
